...
| **Table Shaper (PELLET)** | Wavetable-based waveshaping but its the best one ever with pre slew and post hysteresis along with other creative modifiers. Tables are parametrically designed from basis functions including various saturations clippers and wavefolders. |
