...
| **Loop Crossfade** | Smooth crossfade at loop boundaries to eliminate clicks. Configurable duration (0–1000 ms) per source in the sample menu. Uses symmetrical fade-out/fade-in envelopes around the loop restart point with Q31 fixed-point arithmetic. |
