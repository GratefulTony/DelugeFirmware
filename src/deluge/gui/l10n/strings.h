...
enum class String : size_t {
	...
	STRING_FOR_PARAM_LOCAL_SHAPER_DRIVE,
	...
	STRING_FOR_COMMUNITY_FEATURE_DYNAMICS_FINE_GOLD_KNOB_CHARACTER,
	STRING_FOR_COMMUNITY_FEATURE_DYNAMICS_FINE_GOLD_KNOB_VIBE,
