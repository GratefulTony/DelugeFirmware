...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_OSCILLATOR_TRACKING, "TRCK"},
        {STRING_FOR_OSC_TRACKING_MENU_TITLE, "O*PT"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_SAMPLER, "RETR"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_SOURCE, "RSRC"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_DURATION, "RDUR"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_BITDEPTH, "RBIT"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_CHANNELS, "RCHN"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_MONITOR, "INMO"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_NORMALIZE, "RNRM"},
        {STRING_FOR_RETRO_SAVING, "RETR"},
        {STRING_FOR_RETRO_LOADING, "LOAD"},
        {STRING_FOR_RETRO_NORMALIZING, "NORM"},
        {STRING_FOR_COMMUNITY_FEATURE_DYNAMICS_SOUND_DESIGN, "DYN"},
        {STRING_FOR_COMMUNITY_FEATURE_MOD_FX_POST_DOTT, "MFPD"},
        {STRING_FOR_COMMUNITY_FEATURE_DOTT_ANALYZER, "ANAL"},
        {STRING_FOR_COMMUNITY_FEATURE_DISPERSER_HI_CPU, "DISP"},
        ...
        {STRING_FOR_SINE_SHAPER_DRIVE, "SINE"},
        {STRING_FOR_SINE_SHAPER_HARMONIC, "HARM"},
        {STRING_FOR_SINE_SHAPER_SYMMETRY, "TWST"},
        {STRING_FOR_SINE_SHAPER_MIX, "MIX"},
        {STRING_FOR_SHAPER_DRIVE, "SHPR"},
        {STRING_FOR_SHAPER_SHAPE_X, "KNEE"},
        {STRING_FOR_SHAPER_SHAPE_Y, "COLR"},
        {STRING_FOR_SHAPER_MIX, "MIX"},
        {STRING_FOR_DISPERSER_FREQ, "FREQ"},
        {STRING_FOR_DISPERSER_SPREAD, "SPRD"},
        {STRING_FOR_DISPERSER_FEEDBACK, "FDBK"},
        {STRING_FOR_DISPERSER_STAGES, "STGE"},
        {STRING_FOR_DISPERSER_TOPO, "TOPO"},
        {STRING_FOR_DISPERSER_TWIST, "TWST"},
        {STRING_FOR_SHAPING, "SHAP"},
        {STRING_FOR_SINE_SHAPER_MENU, "SINE"},
        {STRING_FOR_TABLE_SHAPER_MENU, "TABL"},
        {STRING_FOR_DISPERSER_MENU, "DISP"},
        ...
        {STRING_FOR_COMPRESSOR_MODE_SINGLE, "SNGL"},
        {STRING_FOR_COMPRESSOR_MODE_MULTIBAND, "MULT"},
        {STRING_FOR_COMPRESSOR_LOW_CROSSOVER, "LOXO"},
        {STRING_FOR_COMPRESSOR_HIGH_CROSSOVER, "HIXO"},
        ...
        {STRING_FOR_COMPRESSOR_THRESHOLD_UP, "THUP"},
        {STRING_FOR_COMPRESSOR_RATIO_UP, "RTUP"},
        {STRING_FOR_COMPRESSOR_OUTPUT_GAIN, "OUTG"},
        {STRING_FOR_COMPRESSOR_INPUT_GAIN, "INPG"},
        {STRING_FOR_COMPRESSOR_BANDWIDTH, "BW"},
        {STRING_FOR_COMPRESSOR_MASTER, "MSTR"},
        {STRING_FOR_COMPRESSOR_CROSSOVER, "XOVR"},
        {STRING_FOR_COMPRESSOR_LOW_THRESHOLD, "LTHR"},
        {STRING_FOR_COMPRESSOR_LOW_RATIO, "LRAT"},
        {STRING_FOR_COMPRESSOR_LOW_BW, "LBW"},
        {STRING_FOR_COMPRESSOR_LOW_LEVEL, "LLEV"},
        {STRING_FOR_COMPRESSOR_MID_THRESHOLD, "MTHR"},
        {STRING_FOR_COMPRESSOR_MID_RATIO, "MRAT"},
        {STRING_FOR_COMPRESSOR_MID_BW, "MBW"},
        {STRING_FOR_COMPRESSOR_MID_LEVEL, "MLEV"},
        {STRING_FOR_COMPRESSOR_HIGH_THRESHOLD, "HTHR"},
        {STRING_FOR_COMPRESSOR_HIGH_RATIO, "HRAT"},
        {STRING_FOR_COMPRESSOR_HIGH_BW, "HBW"},
        {STRING_FOR_COMPRESSOR_HIGH_LEVEL, "HLEV"},
        {STRING_FOR_COMPRESSOR_CHARACTER, "FEEL"},
        {STRING_FOR_COMPRESSOR_UP_DOWN_SKEW, "SKEW"},
        {STRING_FOR_COMPRESSOR_RESPONSE, "RESP"},
