...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_PATCH_SOURCE_UNISON_INDEX, "UNIS"},
        {STRING_FOR_PATCH_SOURCE_MACRO_1, "MAC1"},
        {STRING_FOR_PATCH_SOURCE_MACRO_2, "MAC2"},
        {STRING_FOR_PATCH_SOURCE_MACRO_3, "MAC3"},
        {STRING_FOR_PATCH_SOURCE_MACRO_4, "MAC4"},
        ...
        {STRING_FOR_SINE_SHAPER_MENU, "SSIN"},
        {STRING_FOR_SINE_SHAPER_DRIVE, "DRIV"},
        ...
        {STRING_FOR_UNISON_INDEX_CURVE, "CURV"},
        {STRING_FOR_UNISON_INDEX_SHAPE, "SHPE"},
        {STRING_FOR_UNISON_INDEX_MAPPING, "MAPP"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_SOURCE, "SRC"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_DURATION, "DUR"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_BITDEPTH, "BITS"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_CHANNELS, "CHAN"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_MONITOR, "MON"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_NORMALIZE, "NORM"},
        {STRING_FOR_RETRO_SAVING, "SAVE"},
        ...
        {STRING_FOR_FOLLOW_MOD_KNOB_CC, "MKCC"},
        {STRING_FOR_FOLLOW_CC_PRESET, "CCPR"},
        ...
        {STRING_FOR_NEXT_ACTION_RANDOM_OTHER, "ROTR"},
        {STRING_FOR_NEXT_ACTION_NEAR, "NEAR"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_DISPERSER_HI_CPU, "DHCP"},
        {STRING_FOR_DISPERSER_MENU, "DISP"},
        {STRING_FOR_DISPERSER_FREQ, "FREQ"},
        {STRING_FOR_DISPERSER_SPREAD, "SPRD"},
        {STRING_FOR_DISPERSER_FEEDBACK, "FEED"},
        {STRING_FOR_DISPERSER_STAGES, "STAG"},
        {STRING_FOR_DISPERSER_TOPO, "TOPO"},
        {STRING_FOR_DISPERSER_TWIST, "TWST"},
        {STRING_FOR_ERODER_MENU, "EROD"},
        {STRING_FOR_ERODER_FREQ, "FREQ"},
        {STRING_FOR_ERODER_CHARACTER, "CHAR"},
        {STRING_FOR_ERODER_DEPTH, "DPTH"},
