...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_SINE_SHAPER_DRIVE, "Sine Shaper"},
        {STRING_FOR_SINE_SHAPER_HARMONIC, "SS Harmonic"},
        {STRING_FOR_SINE_SHAPER_SYMMETRY, "SS Twist"},
        {STRING_FOR_SINE_SHAPER_MIX, "SS Mix"},
        {STRING_FOR_SATURATOR_DRIVE, "Saturator"},
        {STRING_FOR_SATURATOR_SHAPE_X, "Sat Shape X"},
        {STRING_FOR_SATURATOR_SHAPE_Y, "Sat Shape Y"},
        {STRING_FOR_SATURATOR_MIX, "Sat Mix"},
        {STRING_FOR_DISPERSER_FREQ, "Disp Freq"},
        {STRING_FOR_DISPERSER_SPREAD, "Disp Spread"},
        {STRING_FOR_DISPERSER_FEEDBACK, "Disp Feedback"},
        {STRING_FOR_DISPERSER_STAGES, "Disp Stages"},
