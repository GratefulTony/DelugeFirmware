...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_PARAM_LOCAL_TABLE_SHAPER_DRIVE, "Table shaper drive"},
        {STRING_FOR_PARAM_LOCAL_TABLE_SHAPER_MIX, "Table shaper mix"},
        ...
        {STRING_FOR_OSCILLATOR_TRACKING, "Osc tracking"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_SAMPLER, "Retro Sampler"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_SOURCE, "Retro Source"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_DURATION, "Retro Duration"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_BITDEPTH, "Retro Bit Depth"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_CHANNELS, "Retro Channels"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_MONITOR, "Ext In Monitor"},
        {STRING_FOR_COMMUNITY_FEATURE_RETRO_NORMALIZE, "Retro Normalize"},
        {STRING_FOR_RETRO_SAVING, "Retro save"},
        {STRING_FOR_RETRO_LOADING, "Retro load"},
        {STRING_FOR_RETRO_NORMALIZING, "Retro normalize"},
        {STRING_FOR_COMMUNITY_FEATURE_DYNAMICS_SOUND_DESIGN, "Advanced Sound Design"},
        {STRING_FOR_COMMUNITY_FEATURE_MOD_FX_POST_DOTT, "Mod FX Post DOTT"},
        {STRING_FOR_COMMUNITY_FEATURE_DOTT_ANALYZER, "DOTT Analyzer"},
        ...
        {STRING_FOR_OSC_TRACKING_MENU_TITLE, "Osc* pitch tracking"},
        ...
        {STRING_FOR_TABLE_SHAPER_MENU, "Table Shaper"},
        ...
        {STRING_FOR_FEATHERVERB, "Feather"},
        ...
        {STRING_FOR_COMPRESSOR_OUTPUT_GAIN, "Out Gain"},
        {STRING_FOR_COMPRESSOR_INPUT_GAIN, "In Gain"},
        {STRING_FOR_COMPRESSOR_BANDWIDTH, "Bandwidth"},
        {STRING_FOR_COMPRESSOR_MASTER, "Master"},
        {STRING_FOR_COMPRESSOR_CROSSOVER, "Crossover"},
        {STRING_FOR_COMPRESSOR_LOW_THRESHOLD, "L Thres"},
        {STRING_FOR_COMPRESSOR_LOW_RATIO, "L Ratio"},
        {STRING_FOR_COMPRESSOR_LOW_BW, "L BW"},
        {STRING_FOR_COMPRESSOR_LOW_LEVEL, "L Level"},
        {STRING_FOR_COMPRESSOR_MID_THRESHOLD, "M Thres"},
        {STRING_FOR_COMPRESSOR_MID_RATIO, "M Ratio"},
        {STRING_FOR_COMPRESSOR_MID_BW, "M BW"},
        {STRING_FOR_COMPRESSOR_MID_LEVEL, "M Level"},
        {STRING_FOR_COMPRESSOR_HIGH_THRESHOLD, "H Thres"},
        {STRING_FOR_COMPRESSOR_HIGH_RATIO, "H Ratio"},
        {STRING_FOR_COMPRESSOR_HIGH_BW, "H BW"},
        {STRING_FOR_COMPRESSOR_HIGH_LEVEL, "H Level"},
        {STRING_FOR_COMPRESSOR_CHARACTER, "Feel"},
