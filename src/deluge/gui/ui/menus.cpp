...
#include "gui/menu_item/midi/follow/follow_cc_preset.h"
...
#include "gui/menu_item/midi/follow/follow_mod_knob_cc.h"
...
PLACE_SDRAM_BSS stutter::ScatterLatch stutterLatchMenu{STRING_FOR_SCATTER_LATCH, STRING_FOR_SCATTER_LATCH};
PLACE_SDRAM_BSS stutter::QuantizedStutter stutterQuantizedMenu{STRING_FOR_QUANTIZE, STRING_FOR_QUANTIZE};
PLACE_SDRAM_BSS stutter::ScatterPWrite stutterPWriteMenu{STRING_FOR_SCATTER_PWRITE, STRING_FOR_SCATTER_PWRITE};
PLACE_SDRAM_BSS stutter::PitchScale stutterPitchScaleMenu{STRING_FOR_SCATTER_SCALE, STRING_FOR_SCATTER_SCALE};
PLACE_SDRAM_BSS stutter::ScatterDensity stutterDensityMenu{STRING_FOR_SCATTER_DENSITY, STRING_FOR_SCATTER_DENSITY};
PLACE_SDRAM_BSS stutter::Rate stutterRateMenu{STRING_FOR_RATE, STRING_FOR_STUTTER_RATE};
PLACE_SDRAM_BSS stutter::ScatterModeMenu stutterModeMenu{STRING_FOR_SCATTER_MODE, STRING_FOR_SCATTER_MODE};
// Scatter page 2
PLACE_SDRAM_BSS stutter::ScatterZoneA stutterZoneAMenu{STRING_FOR_SCATTER_PATTERN, STRING_FOR_SCATTER_PATTERN};
PLACE_SDRAM_BSS stutter::ScatterZoneB stutterZoneBMenu{STRING_FOR_SCATTER_COLOR, STRING_FOR_SCATTER_COLOR};
PLACE_SDRAM_BSS stutter::ScatterMacroConfig stutterMacroConfigMenu{STRING_FOR_SCATTER_MACRO_CONFIG,
                                                                   STRING_FOR_SCATTER_MACRO_CONFIG};
PLACE_SDRAM_BSS stutter::ScatterMacro stutterMacroMenu{STRING_FOR_SCATTER_MACRO, STRING_FOR_SCATTER_MACRO,
                                                       params::GLOBAL_SCATTER_MACRO};

PLACE_SDRAM_BSS HorizontalMenu stutterMenu{
    STRING_FOR_STUTTER,
    {
...
PLACE_SDRAM_BSS audio_compressor::ModeZone dott_mode{STRING_FOR_COMPRESSOR_MODE, STRING_FOR_COMPRESSOR_MODE};
PLACE_SDRAM_BSS audio_compressor::LinkedThreshold mb_linked_threshold{STRING_FOR_THRESHOLD, STRING_FOR_THRESHOLD};
PLACE_SDRAM_BSS audio_compressor::LinkedRatio mb_linked_ratio{STRING_FOR_RATIO, STRING_FOR_RATIO};
PLACE_SDRAM_BSS audio_compressor::UpDownSkew mb_up_down_skew{STRING_FOR_COMPRESSOR_UP_DOWN_SKEW,
                                                             STRING_FOR_COMPRESSOR_UP_DOWN_SKEW};
PLACE_SDRAM_BSS audio_compressor::LinkedAttack mb_linked_attack{STRING_FOR_ATTACK, STRING_FOR_ATTACK};
PLACE_SDRAM_BSS audio_compressor::LinkedRelease mb_linked_release{STRING_FOR_RELEASE, STRING_FOR_RELEASE};
PLACE_SDRAM_BSS audio_compressor::Character mb_character{STRING_FOR_COMPRESSOR_CHARACTER,
                                                         STRING_FOR_COMPRESSOR_CHARACTER};
PLACE_SDRAM_BSS audio_compressor::Vibe mb_vibe{STRING_FOR_COMPRESSOR_VIBE, STRING_FOR_COMPRESSOR_VIBE};
// Per-band controls: Low
PLACE_SDRAM_BSS audio_compressor::BandThreshold<0> mb_low_threshold{STRING_FOR_COMPRESSOR_LOW_THRESHOLD,
                                                                    STRING_FOR_COMPRESSOR_LOW_THRESHOLD};
PLACE_SDRAM_BSS audio_compressor::BandRatio<0> mb_low_ratio{STRING_FOR_COMPRESSOR_LOW_RATIO,
                                                            STRING_FOR_COMPRESSOR_LOW_RATIO};
PLACE_SDRAM_BSS audio_compressor::BandBandwidth<0> mb_low_bandwidth{STRING_FOR_COMPRESSOR_LOW_BW,
                                                                    STRING_FOR_COMPRESSOR_LOW_BW};
PLACE_SDRAM_BSS audio_compressor::BandOutputLevel<0> mb_low_output_level{STRING_FOR_COMPRESSOR_LOW_LEVEL,
                                                                         STRING_FOR_COMPRESSOR_LOW_LEVEL};
// Per-band controls: Mid
PLACE_SDRAM_BSS audio_compressor::BandThreshold<1> mb_mid_threshold{STRING_FOR_COMPRESSOR_MID_THRESHOLD,
                                                                    STRING_FOR_COMPRESSOR_MID_THRESHOLD};
PLACE_SDRAM_BSS audio_compressor::BandRatio<1> mb_mid_ratio{STRING_FOR_COMPRESSOR_MID_RATIO,
                                                            STRING_FOR_COMPRESSOR_MID_RATIO};
PLACE_SDRAM_BSS audio_compressor::BandBandwidth<1> mb_mid_bandwidth{STRING_FOR_COMPRESSOR_MID_BW,
                                                                    STRING_FOR_COMPRESSOR_MID_BW};
PLACE_SDRAM_BSS audio_compressor::BandOutputLevel<1> mb_mid_output_level{STRING_FOR_COMPRESSOR_MID_LEVEL,
                                                                         STRING_FOR_COMPRESSOR_MID_LEVEL};
// Per-band controls: High
PLACE_SDRAM_BSS audio_compressor::BandThreshold<2> mb_high_threshold{STRING_FOR_COMPRESSOR_HIGH_THRESHOLD,
                                                                     STRING_FOR_COMPRESSOR_HIGH_THRESHOLD};
PLACE_SDRAM_BSS audio_compressor::BandRatio<2> mb_high_ratio{STRING_FOR_COMPRESSOR_HIGH_RATIO,
                                                             STRING_FOR_COMPRESSOR_HIGH_RATIO};
PLACE_SDRAM_BSS audio_compressor::BandBandwidth<2> mb_high_bandwidth{STRING_FOR_COMPRESSOR_HIGH_BW,
                                                                     STRING_FOR_COMPRESSOR_HIGH_BW};
PLACE_SDRAM_BSS audio_compressor::BandOutputLevel<2> mb_high_output_level{STRING_FOR_COMPRESSOR_HIGH_LEVEL,
                                                                          STRING_FOR_COMPRESSOR_HIGH_LEVEL};
// Global controls at end
PLACE_SDRAM_BSS audio_compressor::LowCrossover comp_low_xover{STRING_FOR_COMPRESSOR_LOW_CROSSOVER,
                                                              STRING_FOR_COMPRESSOR_LOW_CROSSOVER};
PLACE_SDRAM_BSS audio_compressor::HighCrossover comp_high_xover{STRING_FOR_COMPRESSOR_HIGH_CROSSOVER,
                                                                STRING_FOR_COMPRESSOR_HIGH_CROSSOVER};
PLACE_SDRAM_BSS audio_compressor::OutputGain mb_output_gain{STRING_FOR_COMPRESSOR_OUTPUT_GAIN,
                                                            STRING_FOR_COMPRESSOR_OUTPUT_GAIN};
PLACE_SDRAM_BSS audio_compressor::MultibandBlend mb_blend{STRING_FOR_BLEND, STRING_FOR_BLEND};

PLACE_SDRAM_BSS submenu::CompressorHorizontalMenu dott_menu{
    STRING_FOR_DOTT,
    {
...
PLACE_SDRAM_BSS reverb::FeatherZone1 reverbFeatherZone1Menu{STRING_FOR_FEATHER_ZONE1};
PLACE_SDRAM_BSS reverb::FeatherZone2 reverbFeatherZone2Menu{STRING_FOR_FEATHER_ZONE2};
PLACE_SDRAM_BSS reverb::FeatherZone3 reverbFeatherZone3Menu{STRING_FOR_FEATHER_ZONE3};
PLACE_SDRAM_BSS reverb::FeatherPredelay reverbFeatherPredelayMenu{STRING_FOR_PREDELAY};
...
PLACE_SDRAM_BSS fx::DynamicsPatchedParam sineShaperDriveMenu{STRING_FOR_SINE_SHAPER_DRIVE, STRING_FOR_SINE_SHAPER_DRIVE,
                                                             params::LOCAL_SINE_SHAPER_DRIVE, RenderingStyle::BAR};
PLACE_SDRAM_BSS fx::SineShaperHarmonic sineShaperHarmonicMenu{STRING_FOR_SINE_SHAPER_HARMONIC};
PLACE_SDRAM_BSS fx::SineShaperTwist sineShaperTwistMenu{STRING_FOR_SINE_SHAPER_SYMMETRY};
PLACE_SDRAM_BSS fx::SineShaperMix sineShaperMixMenu{STRING_FOR_SINE_SHAPER_MIX};

PLACE_SDRAM_BSS HorizontalMenu sineShaperSubMenu{
...
PLACE_SDRAM_BSS fx::TableShaperDrive shaperDriveMenu{STRING_FOR_SHAPER_DRIVE, STRING_FOR_SHAPER_DRIVE,
                                                     params::LOCAL_TABLE_SHAPER_DRIVE, RenderingStyle::BAR};
PLACE_SDRAM_BSS fx::TableShaperShapeX shaperShapeXMenu{STRING_FOR_SHAPER_SHAPE_X};
PLACE_SDRAM_BSS fx::TableShaperShapeY shaperShapeYMenu{STRING_FOR_SHAPER_SHAPE_Y};
PLACE_SDRAM_BSS fx::TableShaperMix shaperMixMenu{STRING_FOR_SHAPER_MIX, STRING_FOR_SHAPER_MIX,
                                                 params::LOCAL_TABLE_SHAPER_MIX, RenderingStyle::BAR};

PLACE_SDRAM_BSS HorizontalMenu tableShaperSubMenu{
...
PLACE_SDRAM_BSS fx::AutomodFreq automodFreqMenu{STRING_FOR_AUTOMOD_FREQ, STRING_FOR_AUTOMOD_FREQ,
                                                params::GLOBAL_AUTOMOD_FREQ};
PLACE_SDRAM_BSS fx::AutomodRate automodRateMenu{STRING_FOR_AUTOMOD_RATE, STRING_FOR_AUTOMOD_RATE};
PLACE_SDRAM_BSS fx::AutomodManual automodManualMenu{STRING_FOR_AUTOMOD_MANUAL, STRING_FOR_AUTOMOD_MANUAL,
                                                    params::GLOBAL_AUTOMOD_MANUAL};
PLACE_SDRAM_BSS fx::AutomodMix automodMixMenu{STRING_FOR_AUTOMOD_MIX, STRING_FOR_AUTOMOD_MIX};
// Page 2: Type, Flavor, Mod, Macro
PLACE_SDRAM_BSS fx::AutomodType automodTypeMenu{STRING_FOR_AUTOMOD_TYPE, STRING_FOR_AUTOMOD_TYPE};
PLACE_SDRAM_BSS fx::AutomodFlavor automodFlavorMenu{STRING_FOR_AUTOMOD_FLAVOR, STRING_FOR_AUTOMOD_FLAVOR};
PLACE_SDRAM_BSS fx::AutomodMod automodModMenu{STRING_FOR_AUTOMOD_MOD, STRING_FOR_AUTOMOD_MOD};
PLACE_SDRAM_BSS fx::AutomodDepth automodDepthMenu{STRING_FOR_AUTOMOD_DEPTH, STRING_FOR_AUTOMOD_DEPTH,
                                                  params::GLOBAL_AUTOMOD_DEPTH};

PLACE_SDRAM_BSS HorizontalMenu automodMenu{
    STRING_FOR_AUTOMOD,
    {
...
PLACE_SDRAM_BSS fx::DisperserFreq disperserFreqMenu{STRING_FOR_DISPERSER_FREQ};
PLACE_SDRAM_BSS fx::DisperserTopo disperserTopoMenu{STRING_FOR_DISPERSER_TOPO};
PLACE_SDRAM_BSS fx::DisperserTwist disperserTwistMenu{STRING_FOR_DISPERSER_TWIST};
PLACE_SDRAM_BSS fx::DisperserStages disperserStagesMenu{STRING_FOR_DISPERSER_STAGES};

PLACE_SDRAM_BSS HorizontalMenu disperserSubMenu{
...
PLACE_SDRAM_BSS fx::EroderCutoff eroderCutoffMenu{STRING_FOR_ERODER_CUTOFF, params::GLOBAL_ERODER_CUTOFF};
PLACE_SDRAM_BSS fx::EroderTone eroderToneMenu{STRING_FOR_ERODER_FREQ};
PLACE_SDRAM_BSS fx::EroderCharacter eroderCharacterMenu{STRING_FOR_ERODER_CHARACTER};
PLACE_SDRAM_BSS fx::EroderMix eroderMixMenu{STRING_FOR_ERODER_MIX};

PLACE_SDRAM_BSS HorizontalMenu eroderSubMenu{
...
PLACE_SDRAM_BSS fx::UtilityVolume utilityVolumeMenu{STRING_FOR_UTILITY_VOLUME};
PLACE_SDRAM_BSS fx::UtilityPanL utilityPanLMenu{STRING_FOR_UTILITY_PAN_L};
PLACE_SDRAM_BSS fx::UtilityPanR utilityPanRMenu{STRING_FOR_UTILITY_PAN_R};
PLACE_SDRAM_BSS fx::UtilityWidth utilityWidthMenu{STRING_FOR_UTILITY_WIDTH};

PLACE_SDRAM_BSS HorizontalMenu utilitySubMenu{
...
PLACE_SDRAM_BSS fx::HarmHarmonic harmHarmonicMenu{STRING_FOR_HARM_HARMONIC};
PLACE_SDRAM_BSS patched_param::Integer harmFineMenu{STRING_FOR_HARM_FINE, STRING_FOR_HARM_FINE,
                                                    params::GLOBAL_HARM_FINE};
PLACE_SDRAM_BSS patched_param::Integer harmLevelMenu{STRING_FOR_HARM_LEVEL, STRING_FOR_HARM_LEVEL,
                                                     params::GLOBAL_HARM_LEVEL};
PLACE_SDRAM_BSS fx::HarmPhase harmPhaseMenu{STRING_FOR_HARM_PHASE};
PLACE_SDRAM_BSS fx::HarmAttack harmAttackMenu{STRING_FOR_HARM_ATTACK};
PLACE_SDRAM_BSS fx::HarmRelease harmReleaseMenu{STRING_FOR_HARM_RELEASE};
PLACE_SDRAM_BSS fx::HarmHpf harmHpfMenu{STRING_FOR_HARM_NOTCH};
PLACE_SDRAM_BSS fx::HarmPorta harmPortaMenu{STRING_FOR_HARM_PORTA};

PLACE_SDRAM_BSS HorizontalMenu harmSubMenu{
...
PLACE_SDRAM_BSS submenu::Shaping shapingMenu{
    STRING_FOR_SHAPING,
    {&sineShaperSubMenu, &tableShaperSubMenu, &automodMenu, &disperserSubMenu, &eroderSubMenu},
};

// Macro routing nodes (global hybrid patched params + mod matrix sources)
PLACE_SDRAM_BSS patched_param::Integer macro1Menu{STRING_FOR_MACRO_1, STRING_FOR_MACRO_1, params::GLOBAL_MACRO_1};
PLACE_SDRAM_BSS patched_param::Integer macro2Menu{STRING_FOR_MACRO_2, STRING_FOR_MACRO_2, params::GLOBAL_MACRO_2};
PLACE_SDRAM_BSS patched_param::Integer macro3Menu{STRING_FOR_MACRO_3, STRING_FOR_MACRO_3, params::GLOBAL_MACRO_3};
PLACE_SDRAM_BSS patched_param::Integer macro4Menu{STRING_FOR_MACRO_4, STRING_FOR_MACRO_4, params::GLOBAL_MACRO_4};

PLACE_SDRAM_BSS HorizontalMenu macrosMenu{
    STRING_FOR_MACRO_MENU,
...
PLACE_SDRAM_BSS audio_clip::StartOffset audioClipStartOffsetMenu{STRING_FOR_START_OFFSET};
...
PLACE_SDRAM_BSS menu_item::CloneSound cloneSoundMenu{STRING_FOR_CLONE};
PLACE_SDRAM_BSS menu_item::SelectRecordSource selectRecordSourceMenu{STRING_FOR_RECORD_SOURCE};
...
PLACE_SDRAM_BSS midi::FollowModKnobCC midiFollowModKnobCCMenu{STRING_FOR_FOLLOW_MOD_KNOB_CC};
PLACE_SDRAM_BSS midi::FollowCCPreset midiFollowCCPresetMenu{STRING_FOR_FOLLOW_CC_PRESET};
...
PLACE_SDRAM_BSS Submenu midiFollowSubmenu{
    ...
    STRING_FOR_FOLLOW_TITLE,
    {
        ...
        &midiFollowModKnobCCMenu,
        &midiFollowCCPresetMenu,
...
PLACE_SDRAM_BSS Submenu soundEditorRootActionsMenu{
    STRING_FOR_ACTIONS,
    {&editNameMenu, &cloneSoundMenu, &selectRecordSourceMenu, &sample0RecorderMenu, &sample1RecorderMenu},
};
